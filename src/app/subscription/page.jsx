                            ...
                            <motion.div className="md:w-1/2 mb-8 md:mb-0 md:px-16" variants={staggerChildren} initial="initial" animate="animate">
                                ...
                                <motion.div className="flex space-x-4" variants={fadeIn}>
                                    ...
                                    <Link href="/howtosubscribe" passHref>
                                        <Button className="px-4 py-2 bg-white text-pink-600 rounded-md hover:bg-pink-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-pink-400" variant="outline" >How To Subscribe →</Button>
                                    </Link>
                                </motion.div>
