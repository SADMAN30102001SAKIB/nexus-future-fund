...
export async function GET(req) {
  const url = `https://mt-client-api-v1.london.agiliumtrade.ai/users/current/accounts/${ACCOUNT_ID}/account-information`;
  ...
  try {
    ...
    return new Response(
      JSON.stringify({ error: "Failed to fetch balance from the API" }),
