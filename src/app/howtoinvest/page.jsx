                        ...
                        <div className="container mx-auto lg:px-36">
                            <motion.div variants={staggerChildren} initial="initial" animate="animate">
                                <div className="bg-gray-800 bg-opacity-50 backdrop-blur-md p-8 rounded-lg shadow-xl">
                                    ...
                                    <motion.p className="text-gray-300 mb-6 text-justify" variants={fadeIn}>At Nexus Future Fund, we make it easy for you to start investing and earning a guaranteed 2% monthly return. Follow these simple steps to join us and begin your journey toward financial growth:</motion.p>
                                    ...
                                    <motion.p className="text-gray-300 mb-6 text-justify" variants={fadeIn}>Feel free to join Nexus Future Fund and start growing your money with confidence. Our platform is designed to be safe, risk-free, and transparent. Let us help you secure your financial future with ease!</motion.p>
