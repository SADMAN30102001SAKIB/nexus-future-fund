        ...
        <Element name="features">
          <section className="py-8 md:py-16 bg-gray-800">
            <div className="container mx-auto md:px-36">
              ...
              >
                {[
                  { icon: CheckCircle, title: "Relaiability", description: "We understand it can be tought to find a safe and reliable platform in a world full of scams. That's why we prioritize transparency, security, and guaranteed returns to ensure that your money is always in trusted hands." },
                  { icon: Shield, title: "Guaranteed safety", description: "We use secure process to protect your information and help prevent unauthorized use. We take pride by offering you a guaranteed 2% monthly return of investment, supported by our expert market researchers." },
                  { icon: Headphones, title: "Friendly support", description: "Whether you're a new investor with questions or a current client looking for support, our team is available 24/7 to ensure you have the best possible experience. Don't hesitate to reach out - we're always happy to help!" }
                ].map((feature, index) => (
            ...
            <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
              ...
              <motion.div className="md:w-1/2 mb-8 md:mb-0 md:px-16" variants={staggerChildren} initial="initial" animate="animate">
                <div className="bg-gray-800 bg-opacity-50 backdrop-blur-md p-8 rounded-lg shadow-xl">
                  ...
                  <motion.p className="text-gray-300 mt-6 text-justify" variants={fadeIn}>Before investing, always check the company&apos;s background, reviews, and credentials. No legitimate investment can offer 100% guaranteed high returns without some level of risk.</motion.p>
                </div>
              </motion.div>
            </div>
          </section>
              ...
              <motion.div className="md:w-1/2 mb-8 md:mb-0 md:px-16" variants={staggerChildren} initial="initial" animate="animate">
                <div className="bg-gray-700 bg-opacity-50 backdrop-blur-md p-8 rounded-lg shadow-xl">
                  ...
                  <motion.p className="text-gray-300 text-justify" variants={fadeIn}>
                    <b className="text-green-200">Top-Tier Research:</b> Our expert team monitors the market 24/7, identifying the most promising crypto assets before they boom.<br />
                    <b className="text-green-200">Strategic Investments:</b> We act quickly and strategically, placing your money where it will grow the fastest and safest.<br /><br />
                    <b className="text-red-200">Why Cryptocurrency?</b><br />
              ...
              <motion.div className="md:w-1/2 mb-8 md:mb-0 md:px-16" variants={staggerChildren} initial="initial" animate="animate">
                <div className="bg-gray-800 bg-opacity-50 backdrop-blur-md p-8 rounded-lg shadow-xl">
                  ...
                  <motion.div className="flex space-x-4  mt-6" variants={fadeIn}>
                    ...
                    <Link href="/howtoinvest" passHref>
                      <Button className="px-4 py-2 bg-white text-pink-600 rounded-md hover:bg-pink-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-pink-400" variant="outline">Learn How To Invest →</Button>
                    </Link>
                  </motion.div>
                </div>
              </motion.div>
                  ...
                  {feedbackData.map((feedback, index) => (
                    ...
                    >
                      <div className="bg-gray-700 bg-opacity-50 backdrop-blur-md p-6 rounded-lg shadow-xl">
                        ...
                        <p className="text-gray-300 mb-4 text-justify">{feedback.comment}</p>
                        <div className="flex">
