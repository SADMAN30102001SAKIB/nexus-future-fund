                                    ...
                                    <motion.ul className="space-y-4" variants={staggerChildren}>
                                        {[
                                            ...
                                            <motion.div variants={fadeIn} key={index}>
                                                ...
                                                <div className="mt-2 mb-8 pl-8 text-gray-300 text-justify" dangerouslySetInnerHTML={{ __html: howToDetails[index] }} />
                                            </motion.div>
                                        ))}
                                    </motion.ul>
                                    <motion.h2 className="text-3xl font-bold mt-12" variants={fadeIn}>Ready to Join? Start Your Trading Journey Today!</motion.h2>
                                    <motion.p className="text-gray-300 mb-6 text-justify" variants={fadeIn}>We are a trusted, transparent, and professional team committed to helping you grow your money securely. Join our premium group and experience expert Bitcoin trading firsthand. Don&apos;t miss your chance to make steady, reliable profits with us!</motion.p>
                                    <Link href="https://t.me/nexusfuturefund" passHref>
